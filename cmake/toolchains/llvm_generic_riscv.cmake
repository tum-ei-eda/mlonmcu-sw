...
if(RISCV_LINUX)
    SET(SYSROOT "${RISCV_ELF_GCC_PREFIX}/${RISCV_ELF_GCC_BASENAME}")
    # SET(SYSROOT "${RISCV_ELF_GCC_PREFIX}/sysroot/usr")
else()
    SET(SYSROOT "${RISCV_ELF_GCC_PREFIX}/${RISCV_ELF_GCC_BASENAME}")
endif()


SET(LLVM_TARGET ${RISCV_ELF_GCC_BASENAME})
...
SET(TC_LD_FLAGS "")
if(RISCV_LINUX)
    LIST(APPEND TC_C_FLAGS "-static")
    LIST(APPEND TC_CXX_FLAGS "-static")
    LIST(APPEND TC_ASM_FLAGS "-static")
