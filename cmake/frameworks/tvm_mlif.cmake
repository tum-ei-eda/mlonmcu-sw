...
SET(EXTRA_SRCS ${EXTRA_SRC} ${SRC_DIR}/${TVM_WRAPPER_FILENAME})
TARGET_LINK_LIBRARIES(${TVM_LIB} PUBLIC tvm_extension m)
SET(EXTRA_INCS ${TVM_OUT_DIR}/include ${SRC_DIR})

SET(EXTRA_LIBS tvm_extension ${TVM_LIB})
SET(EXTRA_DEPS ${TVM_LIB})
...
ENDFOREACH()
FOREACH(ENTRY ${TVM_EXTRA_DEFS})
    TARGET_COMPILE_DEFINITIONS(tvm_extension PUBLIC ${ENTRY})
ENDFOREACH()
