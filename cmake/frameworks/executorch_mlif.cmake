...
SET(EXTRA_SRCS ${EXTRA_SRC} ${SRC_DIR}/${EXECUTORCH_WRAPPER_FILENAME})
# TARGET_LINK_LIBRARIES(${EXECUTORCH_LIB} PUBLIC m)
SET(EXTRA_INCS ${SRC_DIR} ${ET_INCLUDE_PATH} ${ET_INCLUDE_PATH2} ${ET_DIR_PATH}/runtime/core/portable_type/c10)
