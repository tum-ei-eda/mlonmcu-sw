...
MACRO(GVSOC_PULPISSIMO_SETTINGS_PRE)
    SET(GVSOC_PULPISSIMO_INCLUDES
            ...
            # ${GVSOC_LIB_DIR}/drivers/include/cluster
    )
    IF(1)
        SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "GVSOC_FREERTOS_KERNEL")
        FIND_PACKAGE(PulpFreeRTOS COMPONENTS ${FREERTOS_COMP_LIST} REQUIRED)
        SET(GVSOC_PULPISSIMO_INCLUDES ${GVSOC_PULPISSIMO_INCLUDES}
                ${GVSOC_FREERTOS_KERNEL}/include
                ${GVSOC_FREERTOS_KERNEL}/portable/GCC/RISC-V
                ${GVSOC_FREERTOS_KERNEL}/portable/GCC/RISC-V/chip_specific_extensions/PULPissimo
    ...
    IF(${ADD_PLATFORM_FILES})
        ...
        IF(1)
            LIST(APPEND SRC_FILES
                ...
                ${GVSOC_FREERTOS_KERNEL}/portable/MemMang/heap_3.c
            )
        ENDIF()
    ENDIF()
