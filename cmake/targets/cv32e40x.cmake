...
SET(CMAKE_SYSTEM_PROCESSOR cv32e40x)

# Linker file settings.
SET(LINK_FILE "${CMAKE_CURRENT_LIST_DIR}/cv32e40x/link.ld")
SET(LINK_FILE_OPTION "-T")

SET(BOOT_SRCS ${CMAKE_CURRENT_LIST_DIR}/cv32e40x/crt0.S ${CMAKE_CURRENT_LIST_DIR}/cv32e40x/syscalls.c ${CMAKE_CURRENT_LIST_DIR}/cv32e40x/vectors.S ${CMAKE_CURRENT_LIST_DIR}/cv32e40x/handlers.S)
