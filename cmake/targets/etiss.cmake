...
MACRO(COMMON_ADD_LIBRARY TARGET_NAME)
    ...
    ELSEIF("${ARGV1}" STREQUAL "INTERFACE")
        IF(${TOOLCHAIN} STREQUAL "llvm")
            TARGET_LINK_LIBRARIES(${TARGET_NAME} INTERFACE stdc++ supc++ c semihost gcc)
        ENDIF()
    ...
    ELSE()
        IF(${TOOLCHAIN} STREQUAL "llvm")
            TARGET_LINK_LIBRARIES(${TARGET_NAME} PRIVATE stdc++ supc++ c semihost gcc)
        ENDIF()
        TARGET_LINK_LIBRARIES(${TARGET_NAME} PRIVATE etiss_crt0)
    ENDIF()
ENDMACRO()
