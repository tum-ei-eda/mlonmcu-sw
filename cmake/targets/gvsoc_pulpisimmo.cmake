...
# SET(PULP_TC_DIR ${ETISS_DIR}/examples/SW/riscv/cmake)
# ADD_DEFINITIONS(-DPULP_NO_GPIO)

SET(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} cmake/targets/gvsoc_pulp) # !!!!
# IF(NOT PULP_ROM_START)
#     SET(PULP_ROM_START 0x0)
# ENDIF()
# IF(NOT PULP_ROM_SIZE)
#     SET(PULP_ROM_SIZE 0x100000)
# ENDIF()
# IF(NOT PULP_RAM_START)
#     SET(PULP_RAM_START 0x100000)
# ENDIF()
# IF(NOT PULP_RAM_SIZE)
#     SET(PULP_RAM_SIZE 0x200000)
# ENDIF()
# SET(PULP_MIN_STACK_SIZE 0x4000)
# SET(PULP_MIN_HEAP_SIZE 0x4000)
# SET(ETISS_LOGGER_ADDR 0xf0000000)

INCLUDE(PulpTarget)
MACRO(COMMON_ADD_LIBRARY TARGET_NAME)
    ADD_LIBRARY_PULP(${TARGET_NAME} ${ARGN})
ENDMACRO()
MACRO(COMMON_ADD_EXECUTABLE TARGET_NAME)
    SET(ARGS "${ARGN}")
    SET(SRC_FILES ${ARGS})
    ADD_EXECUTABLE_PULP(${TARGET_NAME} ${ARGN})
ENDMACRO()
