...
MESSAGE(STATUS "CMSISNNNN_DIR=${CMSISNN_DIR}")
MESSAGE(STATUS "ARM_MVEI=${ARM_MVEI}")
MESSAGE(STATUS "ARM_DSP=${ARM_DSP}")
...
ExternalProject_Add(cmsisnn
        ...
        CMAKE_ARGS
          ...
          -DARM_MATH_MVEI=${USE_MVEI}
          -DARM_MATH_DSP=${USE_DSP}
...
MESSAGE(STATUS "CMSISNN_LIB=${CMSISNN_LIB}")
