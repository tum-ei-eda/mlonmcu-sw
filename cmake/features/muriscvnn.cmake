...
IF("${MURISCVNN_PORTABLE}" STREQUAL "AUTO")
    IF(USE_PEXT AND NOT RISCV_PEXT)
        SET(USE_PORTABLE ON)
    ELSEIF(USE_VEXT AND NOT RISCV_VEXT)
        SET(USE_PORTABLE ON)
    ELSE()
        SET(USE_PORTABLE OFF)
    ENDIF()
ELSE()
    SET(USE_PORTABLE ${MURISCVNN_PORTABLE})
ENDIF()
